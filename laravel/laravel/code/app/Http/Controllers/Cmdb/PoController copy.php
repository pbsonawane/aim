...
//echo "<pre>";print_r($request);
    ...
    public function complaintRaisedAdd(Request $request)
    {
        ...
        $data['user_id'] = $user_id[0]['user_id'];
        $data['parent_id'] = $user_id[0]['parent_id'];
    ...
    public function getPurchaseRenderFormData(Request $request)
    {
        ...
        $requesternameDetails = $this->iam->getrequesternamesall($option);
        ...
        if ($requesternameDetailsArr) {
            foreach ($requesternameDetailsArr as $requestername) {
                ...
                $requesternameDetailsOptions .= "<option value='" . $requestername['user_id'] . "'>" . $requester_name . "</option>";
            }
        }
        print_r($requesternameDetailsOptions);die;
        //============= Bill To Master
        $option = [];

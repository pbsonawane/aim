...
class ItamService
{
    ...
    public function skucodes($options)
    {
      ...
      public function storesku($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'skucodes', $options);
        return $data;
    }
    ...
    public function getciitems_vendor($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getciitems', $options);
        return $data;
    }
    ...
    public function assignassethistory($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'assignassethistory', $options);
        return $data;
    }
    ...
    /*License Dashboard */
    public function licensedashboard($options)
    {

        $data = $this->remoteapi->apicall("POST", $this->url, 'licensedashboard', $options);
        return $data;
    }
    ...
    // Sample
    public function purchaserequestsavesample($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'purchaserequestsample/add', $options);
        return $data;
    }
    ...
    public function assetskuunit($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'assetskuunit', $options);
        return $data;
    }
    public function checkPOisGeneratedOrNot($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'checkPOisGeneratedOrNot', $options);
        return $data;
    }
    
    public function inStoreAssetCount($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'inStoreAssetCount', $options);
        return $data;
    }
   ...
   public function getassetsbyskus($options)
   {
       $data = $this->remoteapi->apicall("POST", $this->url, 'getassetsbyskus',$options);
       return $data;
   }
...
public function approve_reject_cr($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'approve_reject_cr', $options);
    return $data;
}

public function save_estimatecost($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'save_estimatecost', $options);
    return $data;
}
...
public function trackpurchaserequest($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'trackpurchaserequest', $options);
    return $data;
}

public function addremark($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'addremark', $options);
    return $data;
}

public function add_poremark($options)
{
    
    $data = $this->remoteapi->apicall("POST", $this->url, 'add_poremark', $options);
    return $data;
}
...
public function resendtoapproval($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'resendtoapproval', $options);
    return $data;
}
...
public function getcostcenters($options)
{
    ...
    public function getIssueAsset($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getIssueAsset', $options);
        return $data;
    }

    public function complaintRaisedAdd($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'complaintRaisedAdd', $options);
        return $data;
    }


    public function getvendorsinquotation($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getvendorsinquotation', $options);
        return $data;
    }
    public function getvendorbyservices($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getvendorbyservices', $options);
        return $data;
    }
    public function getvendorservices($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getvendorservices', $options);
        return $data;
    }
    ...
    public function viewvendor($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'vendor/view', $options);
        return $data;
    }
    ...
    //     return $data;
    // }
    public function approvereject_vendor($options) 
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'approvereject_vendor', $options);
        return $data;
    }
...
public function getrequesternamess($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'getrequesternames', $options);
    return $data;
}

public function getRequester($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'getRequester', $options);
    return $data;
}

public function getAssetDetail($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'getAssetDetail', $options);
    return $data;
}

public function syncrequesteruser($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'syncrequesteruser', $options);
    return $data;
}
...
public function readnotification($options)
{
    ...
    // PO
public function getreportdetails_po($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'poreports/details', $options);
    return $data;
}
    // PR
public function getreportdetails_pr($options)
{
    $data = $this->remoteapi->apicall("POST", $this->url, 'prreports/details', $options);
    return $data;
}
...
public function getsoftwareinstallation($options)
{
    ...
    public function getProject($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getProject', $options);
    ...
    public function generatecrnumber($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'generatecrnumber', $options);
        return $data;
    }
    ...
    public function getopportunityDetails($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'opportunitydetails', $options);
        return $data;
    }
    public function getRuntimeopportunities($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'runtimeopportunities', $options);
        return $data;
    }

    public function getusernotification($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getusernotification', $options);
        return $data;
    }

    public function sampleprexportservice($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'getsampleexport', $options);
        return $data;
    }
    public function assetTracking($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'assetTracking', $options);
        return $data;
    }
    public function assetTrackingByEmpId($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'assetTrackingByEmpId', $options);
        return $data;
    }

    public function complaintraisedDetail($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'complaintraisedDetail', $options);
        return $data;
    }
    
    public function addcritremark($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'complaintitremark', $options);
        return $data;
    }
    
    public function addcrstoreremark($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'complaintstoreremark', $options);
        return $data;
    }

    public function complaintraised($options)
    {
        if (isset($options['form_params']['cr_id'])) {
            $data = $this->remoteapi->apicall("POST", $this->url, 'complaintraised/' . $options['form_params']['cr_id'], $options);
        } else {
            $data = $this->remoteapi->apicall("POST", $this->url, 'complaintraised', $options);
        }
        return $data;
    }
    
    public function track_cr_list($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_cr_list', $options);
        return $data;
    }
    public function generatetoken($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'vendors/generatetoken', $options);
        return $data;
    }
    public function verifyotptoken($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'vendors/verifyotptoken', $options);
        return $data;
    }


    public function track_pr_list($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_pr_list', $options);
            return $data;
    }

     public function track_po_list($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_po_list', $options);
      ...
      public function track_po_list_test($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_po_list_test', $options);
        
        return $data;
    }

     public function track_pr_list_for_export($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_pr_list_for_export', $options);
        return $data;
    }


   
    public function track_api_list($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'track_api_list', $options);
    ...
    public function download_vendorattachment($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'download_vendorattachment', $options);
        return $data;
    }
    public function download_complaintattachment($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'download_complaintattachment', $options);
        return $data;
    }
    public function get_pbireports($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'downloadpbireport', $options);
        return $data;
    }

    /**license **/
      public function getlicensedashboard($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'licensedashboard', $options);
        return $data;
    }

    public function getdatabaseboard($options)
     {
        $data = $this->remoteapi->apicall("POST", $this->url, 'databasedashboard', $options);
        return $data;
    }


     public function getcpaneldashboard($options)
     {
        $data = $this->remoteapi->apicall("POST", $this->url, 'cpaneldashboard', $options);
        return $data;
    }


    /**Store license **/
      public function getstoredashboard($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'storedashboard', $options);
        return $data;
    }


    /*******Start Of PurchasePR Report***********/
      public function purchaseprreport($options)
    {
        $data = $this->remoteapi->apicall("POST", $this->url, 'purchaseprreport', $options);
        return $data;
    }

    /*******End OF Purchase PR Report************/


    /******Itam service route for purchase request list
     * 
     ...
     *  *************************************************/
     ...
     public function category_report($options)
     {
        $data = $this->remoteapi->apicall("POST", $this->url, 'category_report', $options);
     ...
     public function newp_pdf($options)
     {
        $data = $this->remoteapi->apicall("POST", $this->url, 'newp_pdf', $options);

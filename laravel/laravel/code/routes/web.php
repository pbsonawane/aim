...
Route::post('/api_service','ApiService@fetchDataFromApi');
/*=========================== Localization ===============================*/
...
Route::get('sendbasicemail', 'MailController@basic_email');
 ...
 Route::post('/save_estimatecost', 'Cmdb\PoController@save_estimatecost');
...
//vendor registration 
Route::any('/vendors', 'Cmdb\VendorRegController@vendors');
Route::any('/vendors/save/{token}', 'Cmdb\VendorRegController@vendoraddsubmit');
Route::any('/vendors/verification/{token}', 'Cmdb\VendorRegController@otpverification');
Route::any('/vendors/registration/{token}', 'Cmdb\VendorRegController@vendorregistration');
Route::post('/vendor/servicesearch', 'Cmdb\VendorController@vendorServicesearch');
...
Route::post('/quotationvendorcomparison/edit', 'Cmdb\PoController@quotation_vendor_cmp_edit');
  ...
  Route::get('/vendor/view/{vendor_id}', 'Cmdb\VendorController@vendor_view');
  Route::post('/approve_reject_vendor', 'Cmdb\VendorController@vendor_approvereject');
  


Route::group(['middleware' => ['web', 'en.auth', 'en.permissions', 'filechecksum']], function () {
    /*=========================== regions ===============================*/
Route::get('/api_service','ApiService@fetchDataFromApi');
    ...
    Route::any('/asset/add', 'Asset\AssetController@assetadd');
    ...
    Route::get('/getsampleexport', 'Cmdb\PoController@sampleprexport');
   

    //  //complained raised
    //  Route::any('/complaintraised', 'Asset\CrController@complaintraised');
    //  Route::post('/complaintraised/list', 'Asset\CrController@complaintraisedlist');
    //  Route::post('/complaintraised/details', 'Asset\CrController@complaintraiseddetail');
    //  Route::post('/complaintraised/add', 'Asset\CrController@complaintraisedadd');
    //  Route::post('/complaintraised/edit', 'Asset\CrController@complaintraisededit');
    //  Route::post('/complaintraised/save', 'Asset\CrController@complaintraisedsave');             

    // SAMPLE PR
    Route::post('/purchaserequestsample/add', 'Cmdb\PoController@purchaserequestaddsample');
    Route::post('/purchaserequestsample/save', 'Cmdb\PoController@purchaserequestsavesample');
    ...
    Route::post('/receive_items_po', 'Cmdb\PoOrderController@prpoformActions');
    ...
    /* ================================== Opportunity =================================*/
    Route::get('/opportunity', 'Cmdb\OpportunityListingController@opportunities'); // Load View
    Route::post('/opportunity/list', 'Cmdb\OpportunityListingController@opportunityList'); // Load Listing
    Route::get('/opportunity/{opportunity_id}', 'Cmdb\OpportunityListingController@getOpportunityDetails');// Details By Id

    Route::post('/opportunity/runtime', 'Cmdb\OpportunityListingController@getRuntimeopportunities');
    ...
    /************Report Task Of Purchase Team ****/
    Route::any('/purchaseprreport','Cmdb\PrUserDashboard@Purchasepr_report');
...
Route::group(['middleware' => ['web', 'en.auth', 'filechecksum']], function () {
  ...
  Route::get('/trackpurchaserequest', 'Cmdb\PoController@track_pr_request'); 
    Route::any('/trackpr/list', 'Cmdb\PoController@track_pr_list');
  
    Route::get('/trackpurchaseorder', 'Cmdb\PoController@track_po_order'); 
    Route::post('/trackpo/list', 'Cmdb\PoController@track_po_list');

    Route::get('/trackpurchasereport', 'Cmdb\PoController@track_pr_data_report'); 
    Route::post('/trackreport/list', 'Cmdb\PoController@track_pr_data_list');


    Route::post('/add_pr_remark', 'Cmdb\PoController@add_remark');
    Route::post('/add_po_remark', 'Cmdb\PoController@add_poremark');
    Route::any('/Export_track_pr', 'Cmdb\PoController@Export_track_pr');
    Route::any('/Export_track_po', 'Cmdb\PoController@Export_track_po');

    /*==Dashboard===*/
    // Route::get('/', 'Asset\AssetController@assets');
      Route::any('/', 'Cmdb\PoController@purchaserequests');
    /*==================== Purchase ==================*/
    Route::post('/assets/assetTracking', 'Asset\AssetController@assetTracking'); 
    Route::post('/complaintRaisedAdd', 'Cmdb\PoController@complaintRaisedAdd');
    ...
    Route::post('/purchaserequest/getProject', 'Cmdb\PoController@getProject');
    // Route::any('/Export_track_pr', 'Cmdb\PoController@Export_track_pr');
    ...
    // 
    Route::get('/assetsSku/{asset_id?}/{ci_templ_id?}/{po_id?}/{asset_sku?}', 'Asset\AssetController@assetsSku');
    // 
    Route::post('/assettree', 'Asset\AssetController@treedata');
    Route::post('/assetdashboardparent', 'Asset\AssetController@dashboard');
    Route::post('/getrequesters', 'Cmdb\RequesternameController@getrequesters');


    Route::post('/assetdashboard', 'Asset\AssetController@assetdashboard');
    //For License
//-----------------------------------------------------------------------------
  //  Route::get('/licenseview','Asset\AssetController@LicenseDashboard');
//Route::get('/licensedashboard/view','Asset\AssetController@LicenseDashboard');
...
//------------------------------------------------------------------------------
    ...
    Route::post('/assignassethistory', 'Asset\AssetController@assignassethistory');
    ...
    Route::get('/downloadPDF{id?}', 'Reports\PoReportsController@downloadPDF');
    Route::post('/getreportmodules', 'Reports\PoReportsController@getreportmodules');
    Route::post('/reports/getreportnotifications', 'Reports\PoReportsController@getreportnotifications');
    Route::post('/reports/readnotification', 'Reports\PoReportsController@readnotification');
    Route::post('getreportformdata', 'Reports\PoReportsController@getReportFormData');

    /*==================== PO Reports ==================*/
    Route::get('/poreports/details/{report_id}', 'Reports\PoReportsController@reportsdetail');
    Route::post('/poreports/details/list', 'Reports\PoReportsController@reportDetailsList');

    /*==================== PR Reports ==================*/
    Route::get('/prreports/details/{report_id}', 'Reports\PrReportsController@reportsdetail');
    Route::post('/prreports/details/list', 'Reports\PrReportsController@reportDetailsList');

    Route::any('/softwaredashboard', 'Cmdb\SoftwareDashboardController@softwaredashboard');

    Route::any('/licensedashboard/view', 'Cmdb\SoftwareDashboardController@license_dashboard_c');

    Route::any('storedashboard', 'Cmdb\SoftwareDashboardController@storedashboard_view');
    ...
    Route::post('/getAssignAsset', 'Cmdb\PoController@getAssignAsset'); 
    ...
    Route::post('/purchaseorder/resendtoapproval', 'Cmdb\PoOrderController@resendtoapproval');  

    /*===================Power BI Reports=====================*/
    Route::get('/pbireports', 'Reports\ReportsController@pbireports');   
    Route::any('/submit_pbireports', 'Reports\ReportsController@submit_pbireports');  
    ...
    Route::post('/download_vendor_docs', 'Cmdb\VendorController@get_vendor_docs');

    
    //complained raised
    Route::any('/complaintraisedreport', 'Asset\CrController@complaintraisedreport');
    Route::post('/trackcr/list', 'Asset\CrController@track_cr_list');
    Route::any('/Export_track_cr', 'Asset\CrController@Export_track_cr');

    Route::any('/complaintraised', 'Asset\CrController@complaintraised');
    Route::post('/complaintraised/list', 'Asset\CrController@complaintraisedlist');
    Route::post('/complaintraised/details', 'Asset\CrController@complaintraiseddetail');
    Route::post('/approve_reject_cr', 'Asset\CrController@approve_reject_cr');
    Route::post('/complaintraised/add', 'Asset\CrController@complaintraisedadd');
    Route::post('/complaintraisedrepair/add', 'Asset\CrController@complaintraisedrepairadd');
    Route::post('/complaintraised/edit', 'Asset\CrController@complaintraisededit');
    Route::post('/complaintraised/save', 'Asset\CrController@complaintraisedsave');    
    Route::post('/complaintraised/itremarksave', 'Asset\CrController@complaintitremarksave');   
    Route::post('/complaintraised/storeremarksave', 'Asset\CrController@complaintstoreremarksave');   
    Route::post('/download_complaint_docs', 'Asset\CrController@download_complaint_docs');   
  
//   Route::get('/get/api','Api\PostAPIController@index');
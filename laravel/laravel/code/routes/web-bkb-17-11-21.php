...
Route::group(['middleware' => ['web', 'en.auth', 'en.permissions', 'filechecksum']], function () {
    ...
    Route::any('/purchaseorders/{id?}', 'Cmdb\PoController@purchaseorders');
    Route::post('/purchaseorder/list', 'Cmdb\PoController@purchaseorderlist');
    Route::post('/purchaseorder/details', 'Cmdb\PoController@purchaseorderdetail');
    Route::post('/purchaseorder/add', 'Cmdb\PoController@purchaseorderadd');
    Route::post('/purchaseorder/save', 'Cmdb\PoController@purchaseordersave');
    Route::post('/purchaseorder/edit', 'Cmdb\PoController@purchaseorderedit');
    Route::post('/purchaseorder/printpreview', 'Cmdb\PoController@printpreview');



    //po invoice
    Route::post('/invoice_po', 'Cmdb\PoController@purchaseinvoices');
    Route::post('/invoice_po/delete', 'Cmdb\PoController@poinvoicedelete');
    Route::post('/invoice_po/addsubmit', 'Cmdb\PoController@prpoformActions');
    Route::post('/invoice_po/editsubmit', 'Cmdb\PoController@prpoformActions');

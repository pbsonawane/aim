...
{   
    ...
    var first_pr_id = $("#crdatabase_id").val();
...
function complaintsubmit() {
    ...
    alert("Internal-IT Remark Saved");
    clearMsg('msg_popup');
    // if (cltimer) {
    //     clas = 'error';
    //     showAlert("msg_popup", clas,  trans('messages.msg_session_open'));
...
function getPurchaseRenderFormDataAdd(vendor_id = '') {
    var url = SITE_URL + '/getPurchaseRenderFormData';
    var vendorajax = ajaxCall(vendorajax, url, {
        vendor_id: vendor_id
    }, function(data) {

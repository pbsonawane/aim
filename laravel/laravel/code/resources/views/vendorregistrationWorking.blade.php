                            ...
                            <form id="vendorForm" action="<?php echo config("app.site_url"); ?>/vendors/save/{{$token}}"
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Registered Business
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_vendor_reference');?></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Warehouse
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Contact Person<span
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Vendor Contact
                                            No</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Vendor Email<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Registered
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Pin Code<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-2">
                                        <label for="inputStandard" class="col-md-12 control-label">GST No<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">GST Prof<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-2">
                                        <label for="inputStandard" class="col-md-12 control-label">PAN No<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">PAN Prof<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">If firm is MSME
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">if Yes, MEME
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Products/Services
                                            Offered: <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="products_services_offered"
                                                id="products_services_offered" class="form-control input-sm">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Association with
                                            OEM:</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Delivery Time</label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-8">
                                        <label for="inputStandard" class="col-md-12 control-label">Payment Terms<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Annual
                                            Turnover</label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-12">
                                        <label for="inputStandard" class="col-md-12 control-label">Known Clients<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_bank_name');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_bank_branch');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Bank Address<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">Bank Passbook
                                            Prof<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_account_type');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_bank_account_no');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_ifsc_code');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label"><?php echo trans('label.lbl_micr_code');?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Director/Proprietor
                                            Name<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Contact Number<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Email<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Sales Officer
                                            Name<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Account Officer
                                            Name<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">Have any legal
                                    ...
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">If Yes please
                                            elaborate</label>
                                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Is the company
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">What is the minimum
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label for="inputStandard" class="col-md-12 control-label">Do the
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">Have there been any
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">Do the Company have
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-6">
                                        <label for="inputStandard" class="col-md-12 control-label">Indicate whether your
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-12">
                                        <label for="inputStandard"
                                            class="col-md-12 control-label">Acknowledgment</label>
                                        <div class="col-md-12">

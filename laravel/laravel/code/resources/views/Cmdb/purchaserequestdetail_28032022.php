                                    ...
                                    <td colspan="2"> <input type="number" class="text_size gley text-right"  id="total_5" name="total_5" readonly="readonly"></td>
                                             ...
                                             <div class="form-group col-md-12">
                                                <div class="form-group">
                                                   <label class="col-md-3 control-label"></label>
                                                   <div class="col-xs-4">
                                                      <button style="width: 100%;" id="pr_qt_Submit" type="button" class="btn btn-success btn-block"><?php echo trans('label.btn_submit'); ?></button>
                                                   </div>
                                                </div>
                                             </div>
                                          </form>

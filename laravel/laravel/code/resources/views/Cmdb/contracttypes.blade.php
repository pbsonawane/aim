...
<div class="topbar-left">
   <?php breadcrum('Contract Types'); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','contracttype'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu">
			<li class="contracttypeadd" title="Contract Type Add">
            <a id="contracttypeadd"><span title="Contract Types Add" class="contracttypeadd"><?php echo trans('label.lbl_add_contract_type');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/contracttypes.js"></script>
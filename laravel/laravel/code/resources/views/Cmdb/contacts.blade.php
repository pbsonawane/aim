...
<div class="topbar-left">
   <?php breadcrum(trans('title.contact')); ?>
</div>
	...
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="contactadd" id="contactadd" title="contact Add">
            <a ><span title="contact Add" class="contactadd"><?php echo trans('label.lbl_add_contact');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/contact.js"></script>
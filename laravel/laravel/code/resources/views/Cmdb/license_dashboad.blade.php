...
<header id="topbar" class="affix"  >
   <div class="topbar-left">
      ...
      <ol class="breadcrumb">
         ...
         <li class="crumb-link"><a href="/softwaredashboard"><?php echo trans('label.lbl_License_dash');?></a></li>
      </ol>
   </div>
      ...
      <div class="btn-group">
         ...
         <ul class="dropdown-menu pull-right" role="menu" >
            <li class="" id="" title="<?php echo trans('label.lbl_sw_list');?>">
               <a href="<?php echo config('api.site_url'); ?>/licensedashboard/view"><span title="<?php echo trans('label.lbl_License_list');?>"><?php echo trans('label.lbl_License_list');?></span></a>
            </li>
         </ul>
      </div>
   </div>
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="panel" id="pchart10">
                                    <div class="panel-heading">
                                       ...
                                       <span class="panel-title"> <?php echo trans('label.lbl_License_types');?></span>
                                    </div>

      ...
      <div class="bg-light pv8 pr10   br-light">
         <div class="row">
            <div class="hidden-xs hidden-sm col-md-12 va-m">
               ...
               <?php }?>
               <?php }
                  if ($pr_first_detail['status'] == "approved" && $pr_first_detail['already_po'] == "") {
                      ?>
               <?php
               if(!empty($item_qt_arr[0]['approval'])){ 

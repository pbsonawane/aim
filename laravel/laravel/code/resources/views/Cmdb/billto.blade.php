...
<div class="topbar-left">
   ...
   <?php breadcrum(trans('title.billto')); ?>
</div>
<div class="topbar-right">
 @if(canuser('create','billto'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="billtoadd" id="billtoadd" title="Bill To Add">
            <a ><span title="Bill To Add" class="billtoadd"><?php echo trans('label.lbl_add_billto');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="<?php echo config('app.site_url'); ?>/enlight/scripts/cmdb/billto.js?<?php echo time();?>"></script>
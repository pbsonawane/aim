            ...
            <div class="render-form">
               <div id="project_external_div" class="hide  formeo-render formeo">
                  ...
                  <div class="f-row">
                     <div class="f-render-column" style="width: 50%;">
                        <div class="f-field-group" >
                           <label for="">Customer PO<span class="text-error">*</span></label>
                           <input name="customer_po_file" type="file" id="customer_po_file">
                        </div>
                     </div>
                     <div class="f-render-column" style="width: 50%;">
                        <div class="f-field-group" >
                           <label for="">GC Approval<span class="text-error">*</span></label>
                  ...
                  <div class="f-row">
                     <div class="f-render-column" style="width: 50%;">
                        <div class="f-field-group" >
                           <label for="">Costing Details Against the Requirement<span class="text-error">*</span></label>
                              ...
                              <td>
                                 <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                          <div class="section">
                                             <select  tabindex="5" data-placeholder="<?php echo trans('label.lbl_selectapprovers'); ?>"  class="chosen-select form-control input-sm approvers_optional_cls" multiple name="approvers_optional[]">

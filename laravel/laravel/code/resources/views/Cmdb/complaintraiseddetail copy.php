...
<div class="panel-heading br-l br-r br-t" style="background-color:aliceblue;">
    <span class="panel-title">
        <?php echo trans('label.lbl_purchaserequest'); ?> -
        <?php echo isset($pr_first_detail['pr_no']) ? $pr_first_detail['pr_no'] : ""?></span>
...
<div class="panel-body bg-light">
    ...
    <div id="podetails_page" class="col-md-12 prn-md animated fadeIn">
        <div class="panel">
            <div class="bg-light pv8 pr10   br-light">
                <div class="row">
                    <div class="hidden-xs hidden-sm col-md-12 va-m">
                        ...
                        <div class="btn-group">
                            <button id="predit"
                                data-id="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>"
                                type="button" class="btn btn-default light"><i class="fa fa-pencil"></i>
                                <?php echo trans('label.btn_editpr'); ?>
                            </button>
                        </div>
                        <?php }?>
                        <?php }
               ...
               if ($pr_first_detail['status'] == "approved" && count($existing_vendor) > 0) {
                 ...
                 if(!empty($item_qt_arr[0]['approval']) && $item_qt_arr[0]['approval'] == 'approved'){ 
                  ...
                  <button id="poview"  data-id="<?php echo $pr_first_detail['already_po']; ?>"type="button" class="btn btn-default light"><i class="glyphicons glyphicons-eye_open"></i> <?php echo trans('label.btn_viewpo'); ?>
                        ...
                        <div class="btn-group">
                            <button id="poview" data-id="<?php echo $pr_first_detail['pr_id']; ?>" data-pr="0"
                                type="button" class="btn btn-default light"><i
                                    class="glyphicons glyphicons-eye_open"></i> View POs
                                <?php //echo trans('label.btn_viewpo'); ?>
                            </button>
                        </div>
                        <?php
         }
         ...
         if(!empty($item_qt_arr[0]['approval']) && $item_qt_arr[0]['approval'] == 'approved'){ 
            if ($pr_first_detail['status'] == "approved"  && count($existing_vendor) < count($item_arr)) {
              if (canuser('create', 'purchaseorder')) {?>
                        <div class="btn-group">
                            <button id="pocreatevendorewise"
                                data-id="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>"
                                type="button" class="btn btn-default light"><i
                                    class="glyphicons glyphicons-folder_plus"></i> Create multiple PO</button>
                        </div>
                        <div class="btn-group">
                            <button id="pocreatevendorewise1"
                                data-id="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>"
                                type="button" class="btn btn-default light"><i
                                    class="glyphicons glyphicons-folder_plus"></i> Clubs PR in one PO</button>
                        </div>
                        <?php }}?>
                        <?php
         }
         if ($pr_first_detail['status'] == "pending approval") {
           ?>
                        <div class="btn-group">
                            <button type="button"
                                id="notifyagain_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"
                                class="actionsPr btn btn-success light"><i class="fa fa-check-square-o"></i>
                     ...
                     if (!empty($pr_first_detail['approved_status']) && $pr_first_detail['status'] == 'approved') {
                        ...
                        if (is_array($approved_status) && !array_key_exists('convert_to_pr', $approved_status) && array_key_exists('confirmed', $approved_status)) {
                           ...
                           if (canuser('advance', 'convert_to_pr')) {?>
                                <li>
                                    <a class="convert_to_pr ccursor" class="actionsPr"
                                        id="convert_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                            class="fa  fa-file-text-o"></i>
                                        <?php echo trans('label.lbl_convert_to_pr'); ?> </a>
                                </li>
                                <?php }}}?>
                                <li>
                                 ...
                                 if (canuser('advance', 'cancel_pr')) {
                                   ?>
                                <li>
                                    <a class="actionsPr ccursor"
                                        id="cancel_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                            class="fa fa-thumbs-down "></i> <?php echo trans('label.lbl_cancelpr'); ?>
                                    </a>
                                </li>
                                <?php }}
                              if ($pr_first_detail['status'] == "pending approval" || $pr_first_detail['status'] == "approved") {
                                if (canuser('delete', 'purchaserequest')) {
                                  ?>
                                <li>
                                    <a class="actionsPr ccursor" class="actionsPr"
                                        id="delete_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                            class="fa fa-trash"></i> <?php echo trans('label.lbl_deletepr'); ?> </a>
                                </li>
                                <?php }}
                              if ($pr_first_detail['status'] == "pending approval" || $pr_first_detail['status'] == "approved") {
                                ...
                                <li>
                                    <a class="actionsPr ccursor" class="actionsPr"
                                        id="close_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                            class="fa fa-close"></i> <?php echo trans('label.lbl_closepr'); ?> </a>
                                </li>
                                <?php
                              }}?>
                                <!--<li class="divider"></li>-->
                                ...
                                <li>
                                    <a class="ccursor actionsPr"
                                        id="notifyowner_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                ...
                                <li>
                                    <a class="ccursor actionsPr"
                                        id="notifyvendor_<?php echo $loggedinUser . "_" . $pr_first_detail['pr_id']; ?>"><i
                                ...
                                <div class="modal-dialog">
                                    <form class="form-horizontal" id="create_multiple_po_form">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"><span id="modal-title_actions"> Select vendor to
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="vendors">
                                                    ...
                                                    <input type="hidden" id="pr_po_id"
                                                        value="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>"
                                                        name="pr_po_id">
                                                    <?php
                                                if (!empty($vendors)) {
                                                   $i = 0;
                                              ...
                                              <input  type="checkbox"  class="selectDeselectAll po_vendor_id" id="enableMailNotificationCheck-<?php echo $i;?>" name="po_vendor_id" value="<?php echo $value['vendor_id'] ?>"> <label for="enableMailNotificationCheck-<?php echo $i;?>"><?php echo $value['vendor_name'] ?></label>
                                                    ...
                                                    <div class="checkbox-custom checkbox-info mb5 po_vendor_id_clk">
                                                        <input type="checkbox" class="selectDeselectAll po_vendor_id"
                                                            id="enableMailNotificationCheck-<?php echo $i;?>"
                                                            name="po_vendor_id"
                                                            value="<?php echo $value['vendor_id'] ?>">
                                                        <label
                                                            for="enableMailNotificationCheck-<?php echo $i;?>"><?php echo $value['vendor_name'] ?></label>
                                                        <div>
                                                            <?php echo $items;?>
                                                        </div>
                                                    </div>
                                    ...
                                    ?>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" id="create_multiple_po"
                                                    class="btn btn-success"><?php echo trans('label.btn_submit'); ?></button>
                                                <button type="button" class="btn btn-default"
                                                    data-dismiss="modal"><?php echo trans('label.btn_close'); ?></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    if (!empty($vendors)) {
                                       ...
                                       foreach ($vendors as $key => $value) {
                                          ...
                                          if(!empty($item_arr[$value['vendor_id']])){
                                             $items = implode(',',$item_arr[$value['vendor_id']]);
                                             ?>
                                       ...
                                       ?>
                                                <button type="button" id="create_multiple_pr_po"
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" id="create_multiple_pr_po_submit"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="checkbox-custom checkbox-info mb5">
                                                    ...
                                                    <label for="enableMailNotificationCheck"><strong>
                                                            <?php echo trans('label.lbl_sendmailnotification'); ?>
                                                        </strong></label>
                                                </div>
                                        ...
                                        <p>Are you Sure you want to <span id="modal-title_actions_2">Cancel / Delete / Close</span> this PR : <strong><?php //echo $pr_first_detail['details']['pr_title']; ?></strong> ? </p>
                                                ...
                                                <div class="form-group required enableMailNotification"
                                                    ...
                                                    <label for="inputStandard"
                                                        class="col-md-12 control-label textalignleft"><?php echo trans('label.lbl_to'); ?></label>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group required enableMailNotification"
                                                    style="display: none;">
                                                    <label for="inputStandard"
                                                        class="col-md-12 control-label textalignleft"><?php echo trans('label.lbl_subject'); ?></label>
                                                    <div class="col-md-12">
                                                        <input class="col-md-12 form-control"
                                                ...
                                                <div class="form-group required ">
                                                    <label for="inputStandard"
                                                        class="col-md-12 control-label textalignleft"><?php echo trans('label.lbl_description_comment'); ?></label>
                                                    <div class="col-md-12">
     ...
     ?>
                    ...
                    <ul class="nav nav-tabs tabs-bg tabs-border">
                        ...
                        <li class="purchase_requesttab active">
                            <a href="#purchase_request" data-toggle="tab" aria-expanded="false"><i
                                ...
                                <?php echo trans('label.lbl_purchaserequest'); ?></a>
                        </li>
                        ...
                        <li class="approve_reject_prtab">
                            <a href="#approvals" data-toggle="tab" aria-expanded="true" style="z-index:10;"><i
                                ...
                                <?php echo trans('label.lbl_approvals'); ?></a>
                        </li>
                        <?php }?>
                        <?php
      if (is_array($approved_status) && array_key_exists('convert_to_pr', $approved_status) && array_key_exists('confirmed', $approved_status)) {
        if (canuser('advance', 'assignprtouser')) { //assignprtouser?>
                        <li class="assignprtousertab">
                            <a href="#assign_pr_to_user" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-users text-purple"></i>
                                <?php echo trans('label.lbl_assign_pr_to_user'); ?></a>
                            </a>
                        </li>
                        <?php }}?>
      ...
      if (canuser('advance', 'uploadquotation')) { //upload_quotation?>
                        <li class="upload_quotationtab">
                            <a href="#upload_quotation" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-upload text-purple"></i>
                                <?php echo trans('label.lbl_upload_quotation'); ?></a>
                            </a>
                        </li>
                        <?php }}?>
                        ...
                        <li class="view_historytab">
                            <a href="#history" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-history text-purple"></i> <?php echo trans('label.lbl_history'); ?></a>
                            </a>
                        </li>
                        <?php }?>
                            ...
                            <div class="panel invoice-panel">
                                <div class="panel-body p20" id="invoice-item">
                                    <div class="row mb30">
                                        <div class="col-md-10">
                                            <div class="pull-left">
                                                <h5 class="mn"> <?php echo trans('label.lbl_req_date'); ?>:
                                                    <?php echo isset($pr_first_detail['details']['pr_req_date']) ? date("d F Y", strtotime($pr_first_detail['details']['pr_req_date'])) : ""; ?>
                                                    | <?php echo trans('label.lbl_due_date'); ?>:
                                                    <?php echo isset($pr_first_detail['details']['pr_due_date']) ? date("d F Y", strtotime($pr_first_detail['details']['pr_due_date'])) : ""; ?>
                                                    | <?php echo trans('label.lbl_status'); ?>: <b
                                  ...
                                  <div class="pull-right text-right">
                                    ...
                                    <div class="row" id="invoice-info">
                                        <div class="col-md-6">
                                            <div class="panel panel-alt">
                                                <div class="panel-heading" style="background-color:aliceblue;">
                                                    <span class="panel-title"> <i class="fa fa-info"></i> Requester &
                                                        Department: </span>
                                             ...
                                             ?>
                                                        ...
                                                        <li> <b><?php echo trans('label.lbl_department'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_department']) ? $pr_first_detail['details']['pr_department'] : ""; ?>&nbsp;|&nbsp;<b><?php echo trans('label.lbl_requirement_for'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_requirement_for']) ? $pr_first_detail['details']['pr_requirement_for'] : ""; ?>
                                                        </li>
                                                        <li> <b><?php echo trans('label.lbl_priority'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_priority']) ? ucwords($pr_first_detail['details']['pr_priority']) : ""; ?>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="panel panel-alt">
                                                <div class="panel-heading" style="background-color:aliceblue;">
                                                    <span class="panel-title"> <i class="fa fa-info"></i> Category &
                                                        Project Details: </span>
                                                    <div class="panel-btns pull-right ml10"> </div>
                                                </div>
                                                <div class="panel-body">
                                                    <ul class="list-unstyled">
                                                        <li> <b><?php echo trans('label.lbl_category'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_category']) ? $pr_first_detail['details']['pr_category'] : ""; ?>&nbsp;|&nbsp;<b><?php echo trans('label.lbl_project_category'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_project_category']) ? $pr_first_detail['details']['pr_project_category'] : ""; ?>
                                                        </li>
                                                        <?php
                                          if (isset($pr_first_detail['details']['pr_project_category']) && $pr_first_detail['details']['pr_project_category'] == 'Internal') {
                                            ?>
                                                        <li> <b><?php echo trans('label.lbl_project_name'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['pr_project_name_dd']) ? $pr_first_detail['details']['pr_project_name_dd'] : ""; ?>
                                                        </li>
                                                        <?php
                                         } else {?>
                                                        <li> <b><?php echo trans('label.lbl_project_name'); ?>:</b>
                                                            <?php echo isset($pr_first_detail['details']['project_name']) ? $pr_first_detail['details']['project_name'] : ""; ?>
                                                        </li>
                                                        <li> <b>Project WO Details:</b>
                                                            <?php echo isset($pr_first_detail['details']['project_wo_details']) ? $pr_first_detail['details']['project_wo_details'] : ""; ?>
                                                        </li>
                                                        <?php }
                                       ?>

                                                        <li> <b>Opportunity Code:</b>
                                                            <?php echo isset($pr_first_detail['details']['opportunity_code']) ? $pr_first_detail['details']['opportunity_code'] : ""; ?>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="panel panel-alt">
                                                ...
                                                <div class="panel-body">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li> <b>Details :</b>
                                                            <?php echo isset($pr_first_detail['details']['ship_to_other']) ? $pr_first_detail['details']['ship_to_other'] : ""; ?>
                                                        </li>
                                                        <?php } else {?>
                                            ...
                                            <div class="panel panel-alt">
                                                <div class="panel-heading" style="background-color:aliceblue;">
                                                    <span class="panel-title"> <i class="fa fa-user"></i>
                                                        <?php echo trans('label.lbl_shipto_contact'); ?> :
                                                    </span>
                                                </div>
                                                <div class="panel-body">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li> <b>Details :</b>
                                                            <?php echo isset($pr_first_detail['details']['ship_to_contact_other']) ? $pr_first_detail['details']['ship_to_contact_other'] : ""; ?>
                                                        </li>
                                                        <?php } else {
                                          ?>
                                                        <li>
                                    ...
                                    <div class="row" id="invoice-table">
                                       ...
                                       <th>Received</th>
                                                    ...
                                                    <tr id="labelRow" style="height:30px;background-color:aliceblue;">
                                                        ...
                                                        <th width="20%" class="text-center">
                                                            <?php echo trans('label.lbl_itemname'); ?></th>
                                       ...
                                       if ($assetdetails) {
                                        ...
                                        ?>
                                             ...
                                             ?>
                                                        ...
                                                        <td><?php echo $asset_details['item_desc']; ?></td>
                                                        <td class="text-center">
                                                            <?php echo $asset_details['item_qty']; ?></td>
                                                        <td class="text-center">0</td>
                                                        <td class="text-center">
                                                            <?php echo $asset_details['warranty_support_required']; ?>
                                                        </td>
                                                        <td><?php 
                                       ...
                                       ?></td>
                                                        <td class="text-center">
                                                            <?php if($asset['convert_status']=='y'){ echo "<span style='color:green;font-weight:bold;'>Yes</span>";}else{echo "<span style='color:red;font-weight:bold;'>No</span>";} ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php 
                                          ...
                                          {    
                                                ...
                                                {
                                                  ?>
                                                            <button type="button" class="qc_added"
                                                                title="Quotation Added"
                                                                style="border-color:green; color:green !important;"
                                                                id="qc_btn"
                                                                onclick="send_item('<?php echo $item_product; ?>','<?php echo $asset_details['item_product_name']; ?>','<?php echo $asset_details['item_qty']; ?>','<?php echo $pr_first_detail['pr_id']; ?>')"><span
                                                ...
                                                {
                                                  ?>
                                                            <button type="button" class="qc_not_added"
                                                                title="Add Quotation"
                                                                style="border-color:blue; color:blue !important;"
                                                                id="qc_btn"
                                                                onclick="send_item('<?php echo $item_product; ?>','<?php echo $asset_details['item_product_name']; ?>','<?php echo $asset_details['item_qty']; ?>','<?php echo $pr_first_detail['pr_id']; ?>')"><span
                                        ...
                                        <div class="panel-body pn">
                                            ...
                                            <div class="col-sm-12 pt10 pl30">
                                                <div class="tray-bin pl10 mb10">
                                                    ...
                                                    <form action="/add_attachment_pr" method="post" class=""
                                                        ...
                                                        <div class="fallback">
                                                            ...
                                                            <input type="hidden" id="attachment_type"
                                                                name="attachment_type" value="pr">
                                                        </div>
                                                        <?php //echo csrf_field(); ?>
                                                        <input type="hidden" name="_token"
                                                            value="<?php echo csrf_token() ?>">
                                                        <input type="submit" id="attachmentbtn"
                                                            value="<?php echo trans('label.btn_upload'); ?>"
                                                            name="submit">
                                                    </form>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table table-striped table-condensed">
                                                        <thead>
                                                            <tr style="height:30px;background-color:aliceblue;">
                                                                ...
                                                                <th><?php echo 'Uploaded '.trans('label.lbl_date'); ?>
                                                                </th>
                                             ...
                                             -->
                                                                <td>
                                                                    <span class="download_file text-primary"
                                                                        ...
                                                                        download_path="<?php echo $attachment['attachment_name']; ?>"
                                                                        download_title="<?php echo  $attachment['file_title']!=null?$attachment['file_title']:trans('label.lbl_attachment') . ' ' . ($key + 1); ?>"><?php echo  $attachment['file_title']!=null?$attachment['file_title']:trans('label.lbl_attachment') . ' ' . ($key + 1); ?>&nbsp;<i
                                                                            class="fa fa-cloud-download"
                                                                            style="color:green;font-size: large;"></i></span>
                                                                </td>
      ...
      ?>
            ...
            <p><b><?php echo trans('label.lbl_approvals'); ?> - </b></p>
                     ...
                     <?php //} ?>-->
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"><span
                                                        id="modal-title_approve_reject"><?php echo trans('label.lbl_rejectapprove'); ?>
                                                    </span> <?php echo trans('label.lbl_thispr'); ?>:
                                                    <?php //echo $pr_first_detail['details']['pr_title']; ?></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group required ">
                                                    <label for="inputStandard"
                                                        class="col-md-12 control-label textalignleft"><?php echo trans('label.lbl_comment'); ?></label>
                                                    <div class="col-md-12">
                                                        <textarea class="col-md-12" name="comment"
                                                            maxlength="250"></textarea>
                                                        <br><code style="float: inline-end;">(Max 250 Characters)</code>
                            ...
                            <div class="col-md-12">
                                <!--<h5 class="mt5 mbn ph10 pb5 br-b fw700">Confirmed <small class="pull-right fw700 text-info">Status</small> </h5>-->
                                   ...
                                   ?>
                                        <tr>
                                            <td><i class="fa fa-circle text-warning fs8 pr15"></i>
                                                <span
                                                    style="color: black"><?php echo $user['firstname'] . " " . $user['lastname']; ?></span>
                                            </td>
                                            <td>
                                                <div class="row">
...
{ 
   ?>
         ...
         { 
          ...
          if($item_count > 0) {  
            ?>
                                <form action="<?php echo url('/PrQuotationComparison/details/'.$pr_id) ?>"
                                    id="PrQuotationComparison" name="PrQuotationComparison" method="post">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <a href="<?php echo url('/prquotationcomparison/details/'.$pr_id) ?>"
                                                    target="_blank" class="btn btn-success btn-block"><strong><span
                                                            class="glyphicon glyphicon-list-alt"></span>&nbsp;Show all
                                                        Quotation Comparisons</strong></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                            ...
                                            <div class="col-md-12 pt10 pln prn">
                                                <div class="col-md-12 pt10 pln prn">
                                                    <div class="table-responsive">
                                                        <form
                                                            action="<?php echo url('/quotationvendorcomparison/add') ?>"
                                                            id="quotationvendorcomparison"
                                                            name="quotationvendorcomparison" method="post">
                                                            <input type="hidden" name="_token"
                                                                value="<?php echo csrf_token() ?>">
                                                            <input type="hidden" id="pr_po_id" name="pr_po_id"
                                                                value="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>">
                                                            ...
                                                            <input type="hidden" id="selected_item_name" value=""
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2" class="text-center">
                                                                            <strong>Vendor 1&nbsp;<span
                                                                                    style="color:red;">*</span></strong></strong>
                                                                        </td>
                                                                        <td colspan="2" class="text-center">
                                                                            <strong>Vendor 2&nbsp;<span
                                                                                    style="color:red;">*</span></strong>
                                                                        </td>
                                                                        <td colspan="2" class="text-center">
                                                                            <strong>Vendor 3&nbsp;<span
                                                                                    style="color:red;">*</span></strong>
                                                                        </td>
                                                                        <td colspan="2" class="text-center">
                                                                            <strong>Vendor 4</strong></td>
                                                                        <td colspan="2" class="text-center">
                                                                            <strong>Vendor 5</strong></td>
                                                                    </tr>

                                                                    <tr>
                                                                        <!-- <td>#</td> -->
                                                                        <td colspan="2" id="ItemGet"
                                                                            style="text-align: center; color:blue;font-weight: bold;">
                                                                        </td>
                                                                        <td colspan="2">
                                                                            <select
                                                                                data-placeholder="<?php echo trans('label.lbl_vendor'); ?>"
                                                                                tabindex="5"
                                                                                class="form-control chosen-select vendor_select"
                                                                                name="pr_vendor_id[]"
                                                                                <?php echo $disabled;?>
                                                                                id="pr_vendor_id_1">
                                                      ...
                                                      if (!empty($vendors)) {
                                                         foreach ($vendors as $key => $value) {?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <!--  <td> </td> -->
                                                                        <td class="text-center"><strong>Rate</strong>
                                                                        </td>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="text-left" style="width:60px;">1
                                                                            Quote</td>
                                                                        <td><input type="number" id="qty_1"
                                                                                class="it_sz gley" name="qty_1[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_1_v1" name="rate_1[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_1_v1" name="amount_1[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_1_v2" name="rate_1[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_1_v2" name="amount_1[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_1_v3" name="rate_1[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_1_v3" name="amount_1[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_1_v4" name="rate_1[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_1_v4" name="amount_1[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_1_v5" name="rate_1[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_1_v5" name="amount_1[]"
                                                                                readonly="readonly"></td>
                                                                    </tr>

                                                                    <tr class="text-center">
                                                                        <!--  <td> </td> -->
                                                                        <td class="text-left" style="width:60px;">2
                                                                            Quote</td>
                                                                        <td><input type="number" id="qty_2"
                                                                                class="it_sz gley" name="qty_2[]"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_2_v1" name="rate_2[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_2_v1" name="amount_2[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_2_v2" name="rate_2[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_2_v2" name="amount_2[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_2_v3" name="rate_2[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_2_v3" name="amount_2[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_2_v4" name="rate_2[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_2_v4" name="amount_2[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_2_v5" name="rate_2[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_2_v5" name="amount_2[]"
                                                                                readonly="readonly"></td>
                                                                    </tr>

                                                                    <tr class="text-center">
                                                                        <!--   <td> </td> -->
                                                                        <td class="text-left" style="width:60px;">3
                                                                            Quote</td>
                                                                        <td><input type="number" id="qty_3"
                                                                                class="it_sz gley" name="qty_3[]"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_3_v1" name="rate_3[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_3_v1" name="amount_3[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_3_v2" name="rate_3[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_3_v2" name="amount_3[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_3_v3" name="rate_3[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_3_v3" name="amount_3[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_3_v4" name="rate_3[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_3_v4" name="amount_3[]"
                                                                                readonly="readonly"></td>
                                                                        <td><input type="number" class="it_sz"
                                                                                id="rate_3_v5" name="rate_3[]"
                                                                                onkeyup="cal(this.id);"
                                                                                onchange="cal(this.id);"
                                                                                onblur="cal(this.id);"></td>
                                                                        <td><input type="number" class="it_sz gley"
                                                                                id="amount_3_v5" name="amount_3[]"
                                                                                readonly="readonly"></td>
                                                                    </tr>

                                                                    <!-- quotation reference no start -->
                                                                    <tr class="text-center">
                                                                        <td colspan="2" class="text-left">Quotation Ref
                                                                            No</td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size"
                                                                                id="quotation_reference_no_1"
                                                                                name="quotation_reference_no_1[]"></td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size"
                                                                                id="quotation_reference_no_2"
                                                                                name="quotation_reference_no_2[]"> </td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="quotation_reference_no_3"
                                                                                name="quotation_reference_no_3[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="quotation_reference_no_4"
                                                                                name="quotation_reference_no_4[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="quotation_reference_no_5"
                                                                                name="quotation_reference_no_5[]"></td>
                                                                    </tr>
                                                                    <!-- quotation reference no end -->

                                                                    <tr class="text-center">
                                                                        <!-- <td class="text-center"><strong>2</strong></td> -->
                                                                        <td colspan="2" class="text-left">Warranty &
                                                                            Support</td>
                                                                        <!-- <td> </td> -->
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size"
                                                                                id="warranty_support_1"
                                                                                name="warranty_support_1[]"></td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size"
                                                                                id="warranty_support_2"
                                                                                name="warranty_support_2[]"> </td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="warranty_support_3"
                                                                                name="warranty_support_3[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="warranty_support_4"
                                                                                name="warranty_support_4[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="warranty_support_5"
                                                                                name="warranty_support_5[]"></td>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <!-- <td > </td> -->
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="gst_extra_1"
                                                                                name="gst_extra_1[]"> </td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="gst_extra_2"
                                                                                name="gst_extra_2[]"></td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="gst_extra_3"
                                                                                name="gst_extra_3[]"> </td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="gst_extra_4"
                                                                                name="gst_extra_4[]"> </td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="gst_extra_5"
                                                                                name="gst_extra_5[]"> </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <!-- <td  class="text-center"><strong>4</strong></td> -->
                                                                        <td colspan="2" class="text-left">Payment terms
                                                                        </td>
                                                                        <!--  <td > </td> -->
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="payment_terms_1"
                                                                                name="payment_terms_1[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="payment_terms_2"
                                                                                name="payment_terms_2[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="payment_terms_3"
                                                                                name="payment_terms_3[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="payment_terms_4"
                                                                                name="payment_terms_4[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="payment_terms_5"
                                                                                name="payment_terms_5[]"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <!--  <td  class="text-center"><strong>5</strong></td> -->
                                                                        <td colspan="2" class="text-left">Freight &amp;
                                                                            Transport</td>
                                                                        <!-- <td > </td> -->
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="transport_1"
                                                                                name="transport_1[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="transport_2"
                                                                                name="transport_2[]"></td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="transport_3"
                                                                                name="transport_3[]"> </td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="transport_4"
                                                                                name="transport_4[]"> </td>
                                                                        <td colspan="2"><input type="text"
                                                                                class="text_size" id="transport_5"
                                                                                name="transport_5[]"> </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <!-- <td  class="text-center"><strong>6</strong></td> -->
                                                                        <td colspan="2" class="text-left">Delivery terms
                                                                        </td>
                                                                        <!-- <td> </td> -->
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="delivery_terms_1"
                                                                                name="delivery_terms_1"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="delivery_terms_2"
                                                                                name="delivery_terms_2"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="delivery_terms_3"
                                                                                name="delivery_terms_3"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="delivery_terms_4"
                                                                                name="delivery_terms_4"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size" id="delivery_terms_5"
                                                                                name="delivery_terms_5"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <!--  <td  class="text-center"><strong>7</strong></td> -->
                                                                        <td colspan="2" class="text-left">Material
                                                                            Details</td>
                                                                        <!--  <td> </td> -->
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="material_description_1"
                                                                                name="material_description_1[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="material_description_2"
                                                                                name="material_description_2[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="material_description_3"
                                                                                name="material_description_3[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="material_description_4"
                                                                                name="material_description_4[]"></td>
                                                                        <td colspan="2"> <input type="text"
                                                                                class="text_size"
                                                                                id="material_description_5"
                                                                                name="material_description_5[]"></td>
                                                                    </tr>
                                                                    <tr class="text-center" style="display: none;">
                                                                        <td colspan="3" class="text-right">
                                                                            <strong>Minimum Amount</strong></td>
                                                                        <td colspan="2"><input type="number"
                                                                                class="text_size gley text-right"
                                                      ...
                                                      <td colspan="2"><input type="radio" class="checkmark" id="pr_qt_Submit" name="approve" value="2">&nbsp;<strong style="display:block;">Approve</strong></td>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="form-group">
                                                                    <label class="col-md-3 control-label"></label>
                                                                    <div class="col-xs-4">
                                                                        <button style="width: 100%;" id="pr_qt_Submit"
                                                                            type="button"
                                                    ...
                                                    <form action="/add_attachment_pr" method="post" class=""
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 25%;"
                                                                data-placeholder="<?php echo trans('label.lbl_vendor'); ?>"
                                                                tabindex="5" class="form-control chosen-select"
                                                                name="pr_vendor_id" id="pr_vendor_id">
                                                                <option value="">-Select-</option>
                                                                <?php
                                                      if (!empty($vendors)) {
                                                         foreach ($vendors as $key => $value) {?>
                                                        ...
                                                        <div class="form-group fallback">
                                                            <input name="file[]" id="quotationuploadFile" type="file"
                                                                multiple='multiple' />
                                                            ...
                                                            <input type="hidden" id="type" name="type" value="document">
                                                            <input type="hidden" id="attachment_type"
                                                                name="attachment_type" value="qu">

                                                        </div>
                                                        <input type="hidden" name="_token"
                                                            value="<?php echo csrf_token() ?>">
                                                        <input type="submit" id="quotationattachmentbtn"
                                                            value="<?php echo trans('label.btn_upload'); ?>"
                                                            name="submit">
                                                    </form>
                                                </div>
                                                    ...
                                                    <table class="table table-striped table-condensed">
                                                        <thead>
                                                            <tr style="height:30px;background-color:aliceblue;">
                                                                ...
                                                                <th><?php echo trans('label.lbl_vendor') .' Name'; ?>
                                                                </th>
                                                                <th><?php echo 'Uploaded '.trans('label.lbl_date'); ?>
                                                                </th>
                                                ...
                                                -->
                                                                <td>
                                                                    <span class="download_file text-primary"
                                                                        ...
                                                                        style="cursor:pointer;"
                                                                        title="<?php echo trans("label.lbl_viewdownload"); ?>"
                                                                        download_path="<?php echo $attachment['attachment_name']; ?>"><?php echo 'Quotation' . ' ' . ($key + 1); ?>&nbsp;<i
                                                                            class="fa fa-cloud-download"
                                                                            style="font-size: large;color:green"></i></span>
                                                                </td>
                                                                <td><?php echo getvendorbyid($attachment['pr_vendor_id']) ?>
                                                                </td>
                                                                <td><?php echo date("d M Y h:i A", strtotime($attachment['created_at'])); ?>
                                                                </td>
                                                                <?php if (canuser('advance', 'delete_attachment_pr')) {?>
                                        ...
                                        <div class="panel-body pn">
                                            ...
                                            <div class="col-sm-8 pt10 pl30">
                                                <div class="tray-bin pl10 mb10">
                                                    <!--<h5 class="text-muted mt10 fw600 pl10"><i class="fa fa-exclamation-circle text-info fa-lg pr10"></i> Portlet Drag and Drop Uploader </h5>-->
                                                    <!--<form action="/add_attachment_pr" method="post" class="dropzone dropzone-sm" id="dropZone" enctype="multipart/form-data">-->
                                                    <form action="/assignprtouser" method="post" class="" id="dropZone"
                                                        enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label>&nbsp;</label>
                                                            <select class="form-control" name="pr_assign_user_id"
                                                                id="pr_assign_user_id">
                                                                <option value="">-Select-</option>
                                                                <?php
                                                if (!empty($allUsers)) {
                                                 ...
                                                 foreach ($allUsers as $value) {
                                                  ...
                                                  ?>
                                                        ...
                                                        <input type="submit" class="btn btn-primary"
                                                            id="assign_pr_to_user_btn" value="Assigned" name="submit">
                                                    </form>
                                                </div>
                                            </div>
                                            <?php }?>
                                                        ...
                                                        <form class="form-horizontal" id="pr_formComment">
                                                            <div class="col-sm-9">
                                                                ...
                                                                <div class="form-group required " style="margin: 10px;">
                                                                    ...
                                                                    <input type="hidden" id="pr_po_id_comment"
                                                                        name="pr_po_id">
                                                                    <input type="hidden" id="user_id_comment"
                                                                        name="user_id">
                                                                    <input type="hidden" id="action_comment"
                                                                        name="action">
                           ...
                           foreach ($prpohistorylog as $history) {
                              if(empty($history['details']))
                              {
                                 if ($history['history_date']) {
                                    ?>
                                                <div class="timeline-divider mtn">
                                                    <div class="divider-label"><?php echo $history['history_date']; ?>
                                                    </div>
                                                    <!--<div class="pull-right">
                                                <button id="timeline-toggle" class="btn btn-default btn-sm">
                                                   <span class="glyphicons glyphicons-show_lines fs16"></span>
...
function send_item(item_id, item_name, item_qty, pr_po_id) {
    ...
    var creTemplateajax = ajaxCall(creTemplateajax, url, postData, function(data) {
        ...
        if (obj.length > 2) {
            ...
            $.each(res3, function(key, value) {
                ...
                $('.vendor_select').not('#pr_vendor_id_' + j).find('option[value="' + prevValue + '"]')
                    .show();
                var value2 = $('#pr_vendor_id_' + j).val();
                $('#pr_vendor_id_' + j).data('previous', value2);
                $('.vendor_select').not('#pr_vendor_id_' + j).find('option[value="' + value2 + '"]')
                    .hide();
                ...
                for (x = 0; x < 3; x++) {
                    ...
                    $('#rate_' + (parseInt(x) + parseInt(1)) + '_v' + j).val(res3[key][x]['rate_' + (
                        parseInt(x) + parseInt(1))]);
                    $('#amount_' + (parseInt(x) + parseInt(1)) + '_v' + j).val(res3[key][x]['amount_' +
                        (parseInt(x) + parseInt(1))
                    ]);
                }
            ...
            for (let i = 1; i < 6; i++) {
                ...
                if (pr_vendor_id_value) {
                    edit_vendorhtml += '<option value=' + pr_vendor_id_value + '>' + pr_vendor_id_text +
                        '</option>';
                }
            }
            ...
            $("#quotationvendorcomparison").find(
                'input:text, input:number, input:password, input:file, select, textarea').val('');
            $("#quotationvendorcomparison").find('input:radio, input:checkbox').removeAttr('checked')
                .removeAttr('selected');
            $('#qty_1').val(item_qty);
            $('#qty_2').val(item_qty);
            $('#qty_3').val(item_qty);

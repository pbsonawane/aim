...
<header id="topbar" class="affix"  >
   <div class="topbar-left">
      ...
      <ol class="breadcrumb">
         <li class="crumb-active nounderline"><a class="nounderline"><?php echo trans('label.lbl_Store_dash');?></a></li>
         ...
         <li class="crumb-link"><a href="storedashboard"><?php echo trans('label.lbl_Store_dash');?></a></li>
      </ol>
   </div>
                  ...
                  <div class="col-md-12">
                     <div class="panel  panel-info panel-border top">
                        <!-- <div class="panel-heading">
                           <span class="panel-title"><i class="fa fa-2x" aria-hidden="true"></i>  <?php echo trans('label.lbl_Store_dash'); ?></span>
                           </div>-->
                        ...
                        <div class="panel-body " id="div_swtype">
                           ...
                           <tr>
                              <td style="color:black;"><?php echo trim($datas['status']);?>
                              </td>
   ...
   <script type="text/javascript">
    ...
    if(operating_dashboard_json != ''){
      for(var i=0; i<operating_dashboard_json.length;i++){
        list_array[i]     = [(operating_dashboard_json[i]).status,(operating_dashboard_json[i]).count];

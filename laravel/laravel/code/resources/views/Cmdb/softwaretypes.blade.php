...
<div class="topbar-left">
   <?php breadcrum(trans('title.softwaretype')); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','softwaretype'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="softwaretypeadd" id="softwaretypeadd" title="Software Type Add">
            <a ><span title="Software Type Add" class="softwaretypeadd"><?php echo trans('label.lbl_add_softwaretype');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/softwaretypes.js"></script>
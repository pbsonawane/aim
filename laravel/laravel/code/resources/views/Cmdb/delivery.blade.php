...
<div class="topbar-left">
   <?php breadcrum(trans('title.delivery'));?>
</div>
	...
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="deliveryadd" id="deliveryadd" title="Delivery Details Add">
            <a ><span title="Delivery Details Add" class="deliveryadd"><?php echo trans('label.lbl_add_delivery'); ?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/delivery.js"></script>
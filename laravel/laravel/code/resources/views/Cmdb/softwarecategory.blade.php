...
<div class="topbar-left">
    <?php breadcrum(trans('title.softwarecategory')); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','softwarecategory'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="softwarecategoryadd" id="softwarecategoryadd" title="Software Category Add">
            <a ><span title="Software Category Add" class="softwarecategoryadd"><?php echo trans('label.lbl_add_softwarecategory');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/softwarecategory.js"></script>
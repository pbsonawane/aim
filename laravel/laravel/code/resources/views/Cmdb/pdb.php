      ...
      <div class="panel">
         ...
         if(!empty($item_qt_arr[0]['approval']) && $item_qt_arr[0]['approval'] == 'approved'){ 
            if ($pr_first_detail['status'] == "approved"  && count($existing_vendor) < count($item_arr)) {
              if (canuser('create', 'purchaseorder')) {?>
               <div class="btn-group">
                  <button id="pocreatevendorewise" data-id="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>"type="button" class="btn btn-default light"><i class="glyphicons glyphicons-folder_plus"></i> Create multiple PO</button>
               </div>
               <div class="btn-group">
                  <button id="pocreatevendorewise1" data-id="<?php echo isset($pr_first_detail['pr_id']) ? $pr_first_detail['pr_id'] : ""; ?>" type="button" class="btn btn-default light"><i class="glyphicons glyphicons-folder_plus"></i> Clubs PR in one PO</button>
               </div>
            <?php }}?>
            <?php
         }
...
<li class="view_commenttab">
   <a href="#pr_comment" data-toggle="tab" aria-expanded="true"><i class="fa fa-comment text-purple"></i> <?php echo 'Comments'; ?></a>
</a>
</li>
</ul>
                                    ...
                                    <tbody>
                                       ...
                                       if ($assetdetails) {
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-center"><?php echo $asset_details['item_qty']; ?></td>
                                       ...
                                       <td class="text-center">
                                          <?php if($asset['convert_status']=='y' && canuser('advance', 'uploadquotation')) { ?>
                                             <button type="button" style="color: darkorange;" onclick="send_item('<?php echo $asset_details['item_product']; ?>','<?php echo $asset_details['item_product_name']; ?>','<?php echo $asset_details['item_qty']; ?>','<?php echo $pr_first_detail['pr_id']; ?>')"><span class="glyphicon glyphicon-th"></span></button>
                                          <?php } else { echo '-'; } ?> 
                                       </td>
                                       <!--
                                       ...
                                       <div class="tray-bin pl10 mb10">
                                          ...
                                          <!--<form action="/add_attachment_pr" method="post" class="dropzone dropzone-sm" id="dropZone" enctype="multipart/form-data">-->
                                             <form action="/add_attachment_pr" method="post" class="" id="dropZone" enctype="multipart/form-data">
                                                ...
                                                <input type="submit" id="attachmentbtn" value="<?php echo trans('label.btn_upload'); ?>" name="submit">
                                             </form>
                                          </div>
                                       </div>
                                    <?php }?>
    ...
    <?php if (canuser('advance', 'approve_reject_pr')) {
      ...
      <div id="approvals" class="tab-pane">
         <div class="pull-left">
                  ...
                  <!--   <?php
                     ...
                     <div class="col-md-8">
                        ...
                        <table class="table mbn tc-med-1 tc-bold-last tc-fs13-last">
                           <thead>
                              <th><?php echo trans('label.lbl_confirmed'); ?></th>
          ...
          echo "<tr><td class='pull-left' colspan='3'>" . trans('messages.msg_norecordfound') . "</td></tr>";
       }
       ?>
    </tbody>
 </table>
...
<div class="col-md-8">
   <table class="table mbn tc-med-1 tc-bold-last tc-fs13-last">
      <thead>
         <th><?php echo trans('label.lbl_optional'); ?></th>
         <th class="textaligncenter"><?php echo trans('label.lbl_status'); ?></th>
      </thead>
      <tbody>
         <?php
...
<?php
 ...
 echo "<tr><td class='pull-left' colspan='2'>" . trans('messages.msg_norecordfound') . "</td></tr>";
}
?>
</tbody>
</table>
               ...
               <div class="form-group col-md-12">
                  <div class="form-group">
                     ...
                     <div class="col-xs-4">
                        ...
                        <a href="<?php echo url('/prquotationcomparison/details/'.$pr_id) ?>" target="_blank" class="btn btn-warning btn-block"><strong><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Show all Quotation Comparisons</strong></a>
                     </div>
                  </div>
               </div>
            </form>
                           ...
                           <div class="table-responsive">
                              <form action="<?php echo url('/quotationvendorcomparison/add') ?>" id="quotationvendorcomparison" name="quotationvendorcomparison" method="post">
                                 ...
                                 <table border=1 class="table table-striped table-condensed">
                                  ...
                                  <tr>
                                    <!-- <td>#</td> -->
                                    <td colspan="2" id="ItemGet" style="text-align: center; color:blue;font-weight: bold;"> </td>
                                    <td colspan="2">
                                       <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id[]" <?php echo $disabled;?> id="pr_vendor_id_1">
                                       ...
                                       <td colspan="2">
                                          <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id[]" id="pr_vendor_id_2" <?php echo $disabled;?>>
                                             <option value="">-Select-</option>
                                             <?php
                                             if (!empty($vendors)) {
                                                foreach ($vendors as $key => $value) {?>
                                          ...
                                          <td colspan="2">
                                             <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id[]" id="pr_vendor_id_3" <?php echo $disabled;?>>
                                                <option value="">-Select-</option>
                                                <?php
                                                if (!empty($vendors)) {
                                                   foreach ($vendors as $key => $value) {?>
                                             ...
                                             <td colspan="2">
                                                <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id[]" id="pr_vendor_id_4" <?php echo $disabled;?>>
                                                   <option value="">-Select-</option>
                                                   <?php
                                                   if (!empty($vendors)) {
                                                      foreach ($vendors as $key => $value) {?>
                                                ...
                                                <td colspan="2">
                                                   <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id[]" id="pr_vendor_id_5" <?php echo $disabled;?>>
                                                      <option value="">-Select-</option>
                                                      <?php
                                                      if (!empty($vendors)) {
                                                         foreach ($vendors as $key => $value) {?>
                                                ...
                                                <tr class="text-center">
                                                   ...
                                                   <td><input type="number" id="qty_1" class="it_sz gley" name="qty_1[]" readonly="readonly"></td>
                                                   <td><input type="number" class="it_sz" id="rate_1_v1" name="rate_1[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                   <td><input type="number" class="it_sz gley" id="amount_1_v1" name="amount_1[]" readonly="readonly"></td>
                                                   <td><input type="number" class="it_sz" id="rate_1_v2" name="rate_1[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                   <td><input type="number" class="it_sz gley" id="amount_1_v2" name="amount_1[]" readonly="readonly"></td>
                                                   <td><input type="number" class="it_sz" id="rate_1_v3" name="rate_1[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                   <td><input type="number" class="it_sz gley" id="amount_1_v3" name="amount_1[]" readonly="readonly"></td>
                                                   <td><input type="number" class="it_sz" id="rate_1_v4" name="rate_1[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                   <td><input type="number" class="it_sz gley" id="amount_1_v4" name="amount_1[]" readonly="readonly"></td>
                                                   <td><input type="number" class="it_sz" id="rate_1_v5" name="rate_1[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                   <td><input type="number" class="it_sz gley" id="amount_1_v5" name="amount_1[]" readonly="readonly"></td>
                                                </tr>

                                                <tr class="text-center">
                                                 <!--  <td> </td> -->
                                                 <td class="text-left" style="width:60px;">2 Quote</td>
                                                 <td><input type="number"  id="qty_2" class="it_sz gley" name="qty_2[]"></td>
                                                 <td><input type="number" class="it_sz" id="rate_2_v1" name="rate_2[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                 <td><input type="number" class="it_sz gley" id="amount_2_v1" name="amount_2[]" readonly="readonly"></td>
                                                 <td><input type="number" class="it_sz" id="rate_2_v2" name="rate_2[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                 <td><input type="number" class="it_sz gley" id="amount_2_v2" name="amount_2[]" readonly="readonly"></td>
                                                 <td><input type="number" class="it_sz" id="rate_2_v3" name="rate_2[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                 <td><input type="number" class="it_sz gley" id="amount_2_v3" name="amount_2[]" readonly="readonly"></td>
                                                 <td><input type="number" class="it_sz" id="rate_2_v4" name="rate_2[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                 <td><input type="number" class="it_sz gley" id="amount_2_v4" name="amount_2[]" readonly="readonly"></td>
                                                 <td><input type="number" class="it_sz" id="rate_2_v5" name="rate_2[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                                 <td><input type="number" class="it_sz gley" id="amount_2_v5" name="amount_2[]" readonly="readonly"></td>
                                              </tr> 

                                              <tr class="text-center">
                                               <!--   <td> </td> -->
                                               <td class="text-left" style="width:60px;">3 Quote</td>
                                               <td><input type="number"  id="qty_3" class="it_sz gley" name="qty_3[]"></td>
                                               <td><input type="number" class="it_sz" id="rate_3_v1" name="rate_3[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                               <td><input type="number" class="it_sz gley" id="amount_3_v1" name="amount_3[]" readonly="readonly" ></td>
                                               <td><input type="number" class="it_sz" id="rate_3_v2" name="rate_3[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                               <td><input type="number" class="it_sz gley" id="amount_3_v2" name="amount_3[]" readonly="readonly"></td>
                                               <td><input type="number" class="it_sz" id="rate_3_v3" name="rate_3[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                               <td><input type="number" class="it_sz gley" id="amount_3_v3" name="amount_3[]" readonly="readonly"></td>
                                               <td><input type="number" class="it_sz" id="rate_3_v4" name="rate_3[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                               <td><input type="number" class="it_sz gley" id="amount_3_v4" name="amount_3[]" readonly="readonly"></td>
                                               <td><input type="number" class="it_sz" id="rate_3_v5" name="rate_3[]" onkeyup="cal(this.id);" onchange="cal(this.id);" onblur="cal(this.id);"></td>
                                               <td><input type="number" class="it_sz gley" id="amount_3_v5" name="amount_3[]" readonly="readonly"></td>
                                            </tr>
                                    ...
                                    <td colspan="2"> <input type="number" class="text_size gley text-right"  id="total_5" name="total_5" readonly="readonly"></td>
                                             ...
                                             <div class="form-group col-md-12">
                                                <div class="form-group">
                                                   <label class="col-md-3 control-label"></label>
                                                   <div class="col-xs-4">
                                                      <button <?php echo $disabled;?> style="width: 100%;" id="pr_qt_Submit" type="button" class="btn btn-success btn-block"><?php echo trans('label.btn_submit'); ?></button>
                                                   </div>
                                                </div>
                                             </div>
                                          </form>
                                          ...
                                          <!--<form action="/add_attachment_pr" method="post" class="dropzone dropzone-sm" id="dropZone" enctype="multipart/form-data">-->
                                             <form action="/add_attachment_pr" method="post" class="" id="dropZone" enctype="multipart/form-data">
                                                <div class="form-group">
                                                   ...
                                                   <select data-placeholder="<?php echo trans('label.lbl_vendor'); ?>" tabindex="5"  class="form-control chosen-select"  name="pr_vendor_id" id="pr_vendor_id">
                                                      <option value="">-Select-</option>
                                                      <?php
                                                      if (!empty($vendors)) {
                                                         foreach ($vendors as $key => $value) {?>
                                                   ...
                                                   <?php //echo csrf_field(); ?>
                                                   <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>">
                                                   <input type="submit" id="quotationattachmentbtn" value="<?php echo trans('label.btn_upload'); ?>" name="submit">
                                                </form>
                                             </div>
                                          </div>
                                       <?php }?>
                                             ...
                                             <select class="form-control" name="pr_assign_user_id" id="pr_assign_user_id">
                                                ...
                                                if (!empty($allUsers)) {
                                                 ...
                                                 foreach ($allUsers as $value) {
                                                  ...
                                                  ?>
                                                  <option <?php echo $selected; ?> value="<?php echo $value['user_id'] ?>"><?php echo $value['firstname'] . ' ' . $value['lastname'] ?></option>
                                               <?php }}?>
                                            </select>
                                         </div>
                                         <div class="form-group">
                        ...
                        <div class="tray-bin pl10 mb10">
                           <form class="form-horizontal" id="pr_formComment">
                              <div class="form-group required ">
                                 ...
                                 <div class="col-md-12">
                                    <textarea class="col-md-12" name="comment" maxlength="250" required></textarea>
                                    <br><code style="float: inline-end;">(Max 250 Characters)</code>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <?php //echo csrf_field(); ?>
                              <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>">
                              <button type="button" id="pr_comment_submit" class="btn btn-success"><?php echo trans('label.btn_submit'); ?></button>
                           </form>
                        </div>
                     </div>
                     <!-- begin: .tray-center -->

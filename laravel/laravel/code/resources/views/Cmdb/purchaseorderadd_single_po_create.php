                    ...
                    <div class="panel"> 
                                            ...
                                            <?php 
                                                if(isset($ciDetails) && !empty($ciDetails))
                                                {
                                                    foreach($ciDetails as $ci)
                                                    {
                                                        ...
                                                        echo "<option value='".$ci['ci_templ_id']."' ".$selected.">".$ci['ci_name']." (".$ci['ci_sku'].")</option>";
                                                    }
                                                }
                                            ?>
                                        </select>
                        ...
                        <?php
                            ...
                            <div class="col-md-6  widget-menu pull-right">
                                ...
                                <div class="col-md-8 pull-right textalignright">
                                   <input id="total_cost" class="form-control input-sm textalignright"  name="total_cost" disabled   value="<?php echo number_format($total_cost,2,'.','');?>" >
                                </div>
                            </div>
                        </div>
                    </div>

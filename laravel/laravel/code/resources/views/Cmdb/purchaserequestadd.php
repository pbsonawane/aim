...
<option label="Airoli DC" value="Airoli DC" <?php
if (isset($purchaserequestdetail['details']['pr_project_name_dd']) && $purchaserequestdetail['details']['pr_project_name_dd'] == 'Airoli DC') {echo 'selected="selected"';}?>>Airoli DC</option>
                           </select>
                        </div>
                     </div>
                     <?php                     

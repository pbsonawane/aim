...
<div class="topbar-left">
   <?php breadcrum(trans('title.relationshiptype')); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','relationshiptype'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu">
			<li class="relationshiptypeadd" title="<?php echo trans('label.lbl_addrelationshiptype');?>">
            <a id="relationshiptypeadd"><span title="<?php echo trans('label.lbl_addrelationshiptype');?>" class="relationshiptypeadd"><?php echo trans('label.lbl_addrelationshiptype');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/relationshiptypes.js"></script>
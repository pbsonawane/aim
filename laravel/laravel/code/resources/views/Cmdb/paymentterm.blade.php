...
<div class="topbar-left">
   <?php breadcrum(trans('title.paymentterm'));?>
</div>
	...
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="paymenttermadd" id="paymenttermadd" title="Payment Term Add">
            <a ><span title="Payment Term Add" class="paymenttermadd"><?php echo trans('label.lbl_add_paymentterm'); ?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/paymentterm.js"></script>
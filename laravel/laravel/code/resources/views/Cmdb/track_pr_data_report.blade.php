...
<div id="content">
  <div class="row">
    <div class="col-md-12">
      <form type="hidden" class="save_dbtbl_prm" id="save_dbtbl_prm" name="save_dbtbl_prm" method="post" action="{{ url('/Export_track_po') }}">
        @csrf
...
<script>
  ...
  function trackpoList() {
    ...
    $(document).on("click", ".add_remark", function () {
      ...
      $("#myModal_add_remark #po_id").val(po_id);
  });

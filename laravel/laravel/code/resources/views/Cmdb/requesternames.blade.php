...
<div class="topbar-left">
   <?php breadcrum(trans('title.requestername')); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','purchaserequest'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="requesternameadd" id="requesternameadd" title="requestername Add">
            <a ><span title="requestername Add" class="requesternameadd"><?php echo trans('label.lbl_add_requestername');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="enlight/scripts/cmdb/requestername.js?<?php time();?>"></script>
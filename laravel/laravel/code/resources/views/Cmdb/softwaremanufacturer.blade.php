...
<div class="topbar-left">
    <?php breadcrum(trans('title.softwaremanufacturer')); ?>
</div>
<div class="topbar-right">
  @if(canuser('create','softwaremanufacturer'))
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu" >
			<li class="softwaremanufactureradd" id="softwaremanufactureradd" title="Software Manufacturer Add">
            <a ><span title="Software Manufacturer Add" class="softwaremanufactureradd"><?php echo trans('label.lbl_add_softwaremanufacturer');?></span></a>
			</li>
		</ul>
	</div>
  @endif
...
<script language="javascript" type="text/javascript" src="<?php config('app.site_url')?>enlight/scripts/cmdb/softwaremanufacturer.js"></script>
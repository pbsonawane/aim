...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline" href="<?php echo url()->current();?>">Modules</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail">Module List</li>
  </ol>
</div>
<div class="topbar-right">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right" role="menu">
			<li class="moduleadd" title="Module Add">
				<a id="moduleadd"><span>Add Module</span></a>
			</li>
		</ul>
	</div>
</div>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/modules.js"></script>
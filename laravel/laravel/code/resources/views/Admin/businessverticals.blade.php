...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline">Business Verticals</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail">Business Verticals List</li>
  </ol>
</div>
<div class="topbar-right">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right" role="menu">
			<li class="businessverticaladd" title="Business Vertical Add">
            <a id="businessverticaladd"><span>Add Business Vertical</span></a>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/businessverticals.js"></script>
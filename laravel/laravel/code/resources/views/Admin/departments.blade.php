...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline">Departments</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail">Departments List</li>
  </ol>
</div>
	...
	<div class="btn-group">
		...
		<span class="glyphicons glyphicons-show_lines fs16"></span>
		 ...
		 <ul class="dropdown-menu pull-right" role="menu">
			<li class="departmentadd" title="Department Add">
				<a id="departmentadd"><span title="Department Add">Add Department</span></a>
			</li>
		</ul>
	</div>
</div>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/departments.js"></script>
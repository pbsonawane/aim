    ...
    <div class="col-md-12">
        <div class="panel panel-visible">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label"></label>
                <div class="col-xs-2">
                    <button id="settingstemplatesubmit" type="button" class="btn btn-success btn-block"><?php echo $action == "add" ? "Save" : "Update"; ?></button>
                </div>
                <div class="col-xs-2">
                    <button id="settingtemplateaddsubmit_reset" type="button" class="btn btn-info btn-block">Reset</button>
                </div>
            </div>

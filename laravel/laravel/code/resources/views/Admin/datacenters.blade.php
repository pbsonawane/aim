...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline">Datacenters</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail"><a href="<?php echo url()->current();?>">Datacenters List</a></li>
  </ol>
</div>
<div class="topbar-right">
    ...
    <ul class="dropdown-menu pull-right" role="menu">
      <li id="dcadd" title="Datacenter Add" >
        <a ><span class="dcadd">Add Datacenter</span></a>
      </li>
    </ul>
  </div>
</div>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/datacenters.js"></script>
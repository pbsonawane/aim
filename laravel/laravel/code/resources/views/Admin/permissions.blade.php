...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline">Permission</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail"><a class="nounderline" href="<?php echo url()->current();?>">Permission List</a></li>
  </ol>
</div>
<div class="topbar-right">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right" role="menu">
            <li class="permissionadd" title="Permission Add">
				<a id="permissionadd"><span title="Permission Add">Add Permission</span></a>
			</li>
		</ul>
	</div>
</div>
...
<div id="content">
  <div class="row">
    ...
    <div class="col-md-12">
    	<form method="post" name="frmpermissions" id="frmpermissions">
      		<div class="panel">
				<?php echo csrf_field(); ?>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/permissions.js"></script>

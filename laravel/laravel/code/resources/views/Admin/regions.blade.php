...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline" href="<?php echo url()->current();?>">Regions</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail">Region List</li>
  </ol>
</div>
<div class="topbar-right">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right" role="menu">
			<li class="regionadd" title="Region Add">
				<a><span title="Region Add">Add Region</span></a>
			</li>
		</ul>
	</div>
</div>
...
<script language="javascript" type="text/javascript" src="enlight/scripts/admin/regions.js"></script>
...
<div class="topbar-left">
  <ol class="breadcrumb">
    <li class="crumb-active"><a class="nounderline">Credential</a></li>
    <li class="crumb-link">Admin</li>
    <li class="crumb-trail">Credential</li>
  </ol>
</div>
<div class="topbar-right">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right" role="menu">
			<li class="crelist" title="Credential Add">
				<a><span title="Alerts" class="notification">Add Credential</span></a>
            </li>
		</ul>
	</div>
</div>
...
<script language="javascript" type="text/javascript" src="<?php echo config('app.site_url'); ?>/enlight/scripts/admin/credential.js"></script>
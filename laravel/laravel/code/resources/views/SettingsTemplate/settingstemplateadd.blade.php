...
<div class="row" id="settingstemplateform">
    <div class="col-md-10">
    ...
    <div class="col-md-12">
        <div class="panel panel-visible">
            ...
            <!--<form class="form-horizontal" role="form" name="settingstemplateaddform" id="settingstemplateaddform">-->
            ...
            <div class="col-md-6">
                <div class="form-group required clearfix ">                    
                        <label for="template_title" class="col-md-3 control-label">{{ trans('label.lbl_template_title') }}</label>
                        <div class="col-md-9">
            ...
            <div class="col-md-6">
                <div class="form-group required clearfix ">
                    <label for="template_name" class="col-md-3 control-label">{{ trans('label.lbl_template_name') }}</label>
                    <div class="col-md-9">
            ...
            <div class="col-md-6">
                <div class="form-group required clearfix ">
                    <label for="type" class="col-md-3 control-label">{{ trans('label.lbl_type') }}</label>
                    <div class="col-md-9">
                    <?php $cmn_teplate_type = trans('commonarr.template_type'); ?>
                        <select  class="form-control input-sm"  name="type"  id="type">
                           ...
                           if(is_array($cmn_teplate_type) && count($cmn_teplate_type) > 0 )
                            {
                                foreach($cmn_teplate_type as $key => $type){
                                ?>
                                <option value="<?php echo $key; ?>" <?php echo isset($form_templ_data['type']) && $form_templ_data['type'] == $key ? "selected" : ""; ?>><?php echo $type; ?></option>
                                <?php 
                                }
                            }
                            ?>
            ...
            <div class="col-md-6">
                <div class="form-group required clearfix ">
                    <label for="default_template" class="col-md-3 control-label">{{ trans('label.lbl_default_template') }}</label>
                    <div class="col-md-9">
                    <?php $cmn_yes_no = trans('commonarr.yes_no'); ?>
                        <select  class="form-control input-sm"  name="default_template"  id="default_template">
                        <?php                           
                        if(is_array($cmn_yes_no) && count($cmn_yes_no) > 0 )
                            {
                                foreach($cmn_yes_no as $key => $type){
                                ?>
                                <option value="<?php echo $key; ?>" <?php echo isset($form_templ_data['default_template']) && $form_templ_data['default_template'] == $key ? "selected" : ""; ?>><?php echo $type; ?></option>
                                <?php 
                                }
                            }
                        ?>
            ...
            <div class="form-group required clearfix">
                <label class="col-md-12 control-label">{{ trans('label.lbl_generate_template') }}</label>
                <section id="main_content" class="inner">
                    <form id="build-form" class="build-form clearfix"></form>
                    <div class="render-form"></div>
                </section>
                <div class="render-btn-wrap">
                    <button id="renderForm" class="btn btn-outline-primary">{{ trans('label.btn_preview_form') }}</button>
                    <button id="viewData" class="btn btn-outline-success">{{ trans('label.btn_generate_json_data') }}</button>
                    <!--<button id="reloadBtn" class="btn btn-outline-danger">{{ trans('label.btn_reset') }}</button>-->
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group required clearfix ">
                    <label for="description" class="col-md-12 control-label">{{ trans('label.lbl_description') }}</label>
                    <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group clearfix">
                    <label for="description" class="col-md-12 control-label">{{ trans('label.lbl_generated_json') }}</label>
                    <div class="col-md-12">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label"></label>
                <div class="col-xs-2">
                    <button id="settingstemplatesubmit" type="button" class="btn btn-success btn-block"><?php echo $action == "add" ? trans('label.btn_submit') : trans('label.btn_update'); ?></button>
                </div>
                <div class="col-xs-2">
                    <button <?php if ($action == "add") { ?> id ="settingtemplateaddsubmit_reset" <?php }else{ ?> id="reset" <?php } ?> type="button" class="btn btn-info btn-block">{{ trans('label.btn_reset') }}</button>
                </div>
            </div>
...
$(document).ready(function()
{
   ...
   // var jsonDataAsString = '<?php //echo isset($form_templ_data['details']) ? $form_templ_data['details'] : ""; ?>';
    var jsonDataAsString_exp = '<?php echo isset($details_arr_lang) ? $details_arr_lang : ""; ?>';
    console.log(jsonDataAsString_exp);
    if(jsonDataAsString_exp!="")
    {
        setDataedit(jsonDataAsString_exp);         
    }
});

 function setDataedit(jsonDataAsString_exp){
  ...
  formeo = new window.Formeo(formeoOpts, jsonDataAsString_exp);
  //formeo.i18n.setLang('ja-JP');
};
</script>

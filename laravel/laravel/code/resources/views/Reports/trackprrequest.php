...
<form id="form1">
	<div class="col-md-12">
	<div class="col-md-4">
	<input id="txt_project" type="text" class="" placeholder="Search Project Name" class="search_">
	</div>

<!-- For status --->
	  		<div class="col-md-4">
	 <input id="txt_status" type="text" class="" placeholder="Search Status" class="search_">
	  </div>
<!-- End For Status -->	

<!-- For Name --->
	  		<div class="col-md-4">
	 <input id="txt_name" type="text" class="" placeholder="Search Name" class="search_">
	  </div>
<!-- End For Name -->	

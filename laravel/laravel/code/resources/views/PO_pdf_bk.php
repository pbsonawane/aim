    ...
    <table class="table" border="1">
        ...
        if(!empty($items_array)){
          ...
          foreach($items_array as $values){
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $items->item_estimated_cost;?></td>
              <td class="text-center"><?php echo $gst_extra;?></td>
              <td class="text-center"><?php echo number_format(($items->item_estimated_cost * $items->item_qty),2,',','');?></td>
            </tr>
          <?php }}else{?>
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
            <td width="30%">ESDS GST No:27AABCE4981A1ZV</td>
            <td width="70%">ESDS PAN No : AABCE4981A</td>
          </tr>
          <tr>
            <td colspan="2">
              ...
              3. Refer Standard ESDS Terms: PTO<br></br><br></br><br><br>
              <img src="po_header/RN_Sign_Stamp.jpg">
              <br><br>
              <br>Thanks and Regards,<br>
              Authorised Signatory,<br><br><br>
              <span class="bold-text">&nbsp;&nbsp;For ESDS Software Solution Pvt. Ltd. </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-right bold-text">Acceptance by Supplier</span>
            </td>
          </tr>
        </tbody>
      </table>
                  ...
                  <td style="border-bottom: 0px;">
                    <table class="" style="border-bottom: 0px;">
                      <?php foreach ($v as $value) {  ?>
                       <tbody>
                        <tr>
                          <td width="15%" class="text-center borderleft" style="border-bottom: 0px;border-spacing: 0px;border-collapse: collapse;border-top-color: #aca5a5;"><?php echo $value->qty; ?></td>
                          <td width="85%" class="borderright" style="border-top-color: #aca5a5;border-bottom: 0px;"><?php echo $value->location; ?></td>
                        </tr>
                         </tbody>
                   <?php 
                    }?>

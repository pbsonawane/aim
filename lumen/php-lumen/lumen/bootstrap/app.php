...
$app->routeMiddleware([
    'en.permissions' => App\Http\Middleware\EnPermissionMiddleware::class,
]);

 // for cross origin allow access 
 $app->middleware([
...
// Elastic search client
 ...
 class_alias(Basemkhirat\Elasticsearch\Facades\ES::class, 'ES');

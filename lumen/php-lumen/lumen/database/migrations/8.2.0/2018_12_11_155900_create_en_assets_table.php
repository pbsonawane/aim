    ...
    public function up()
    {
        if (!Schema::hasTable('en_assets')){
            Schema::create('en_assets', function (Blueprint $table){
                ...
                $table->string('asset_sku', 50)->nullable($value = true);
            ...
            DB::statement('ALTER TABLE `en_assets` MODIFY `department_id` BINARY(16);');
            DB::statement('ALTER TABLE `en_assets` MODIFY `po_id` BINARY(16);');

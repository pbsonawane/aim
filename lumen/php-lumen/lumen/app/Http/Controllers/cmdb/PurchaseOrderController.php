...
/**************Get Track Po List New Function *******************/
   public function track_po_list(Request $request)
    {   
        $inputdata                      = $request->all();
        $inputdata['searchkeyword']     = trim(_isset($inputdata, 'searchkeyword'));
        $totalrecords                   = EnPurchaseOrder::get_track_po_list($inputdata, true);
        $result                         = EnPurchaseOrder::get_track_po_list($inputdata, false);
...
/********Track PO List Export ***************/
	    public function track_po_list_for_export(Request $request)
    {   
        $inputdata                      = $request->all();
        $inputdata['searchkeyword']     = trim(_isset($inputdata, 'searchkeyword'));
        $totalrecords                   = EnPurchaseOrder::get_track_po_list_for_export($inputdata, true);
        $result                         = EnPurchaseOrder::get_track_po_list_for_export($inputdata, false);
   ...
   public function track_api_list(Request $request)
    {   
        $inputdata                      = $request->all();
        $inputdata['searchkeyword']     = trim(_isset($inputdata, 'searchkeyword'));
        $totalrecords                   = EnPurchaseOrder::get_project_costing_api($inputdata, true);
        $result                         = EnPurchaseOrder::get_project_costing_api($inputdata, false);
